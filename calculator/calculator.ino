...
byte rowPins[ROWS] = { 64, 62, 68, 66 };// Connect keypad ROW0, ROW1, ROW2 and ROW3 to these Arduino pins.
byte colPins[COLS] = { 65, 63, 69, 67 }; // Connect keypad COL0, COL1 and COL2 to these Arduino pins.
